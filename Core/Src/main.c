...
void StartTask14(void const * argument);
void StartTask15(void const * argument);
...
/* Configure the peripherals common clocks */
  ...
  /* Initialize all configured peripherals */
    ...
    /* USER CODE BEGIN 2 */
    MX_USB_DEVICE_Init();
    FEE_RTOS_Innit(); // khoi tao du lieu chay RTOS	
    FEE_Robot_Innit(); // cau hinh cac chuc nag robot
  ...
  myTask11Handle = osThreadCreate(osThread(myTask11), NULL);
    ...
    /* definition and creation of myTask09 */
  osThreadDef(myTask12, StartTask12, osPriorityIdle, 0, 128);
  myTask12Handle = osThreadCreate(osThread(myTask12), NULL);
  
    /* definition and creation of myTask09 */
  osThreadDef(myTask13, StartTask13, osPriorityIdle, 0, 128);
  myTask13Handle = osThreadCreate(osThread(myTask13), NULL);
  
    /* definition and creation of myTask09 */
  osThreadDef(myTask14, StartTask14, osPriorityIdle, 0, 128);
  myTask14Handle = osThreadCreate(osThread(myTask14), NULL);
  
    /* definition and creation of myTask09 */
  osThreadDef(myTask15, StartTask15, osPriorityIdle, 0, 128);
...
void PeriphCommonClock_Config(void)
{
  ...
  */
  PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_USB|RCC_PERIPHCLK_I2C2
                              |RCC_PERIPHCLK_I2C1|RCC_PERIPHCLK_UART5
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA,GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3| GPIO_PIN_4|GPIO_PIN_8|GPIO_PIN_9|GPIO_PIN_10
  ...
  /*Configure GPIO pins : PC2 PC3 PC9 PC12 */
  ...
  /*Configure GPIO pins : PA4 PA8 PA9 PA10
	  ...
	  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_8|GPIO_PIN_9|GPIO_PIN_10
                          |GPIO_PIN_15;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
